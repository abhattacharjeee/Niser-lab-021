//Actually I'm Archisman Bhattacharjee
//Roll-1711031
#include<iostream>
using namespace std;
...
class node{   // I'm trying to define node class
	public:
	int data;  //I think here the data hold the data of every elements in linked list
...
//Wow, Finally I finished. Total 221 lines. Terrible.
